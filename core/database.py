...
class Database:
    ...
    async def connect(self):
        ...
        try:
            ...
            # We avoid logging 'e' directly because it may contain the DSN (including password)
            logger.error("Failed to connect to database. Check your POSTGRES_DSN configuration.")
            raise
